...
class Guest_Author_Role {
	...
	public static function admin_footer() {
		global $pagenow;
		wp_enqueue_script( 'guest-author-role', plugins_url( 'guest-author-role/guest-author-role.js', COAUTHORS_PLUS_FILE ), array( 'jquery' ), COAUTHORS_PLUS_VERSION, true );

		wp_localize_script( 'guest-author-role', 'guestAuthorRole', [
			'role' => self::ROLE,
